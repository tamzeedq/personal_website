    ...
    <div className='min-h-screen flex'>
      ...
      <div className='w-[50%] max-h-[100%] py-16 px-8 overflow-y-scroll no-scrollbar text-white'>
        ...
        <p>
          ...
          I am a developer for UBC Solar's Simulation Team, and have just completed a co-op as a full-stack developer and software engineer at Tetra Tech. <br /> <br />
        ...
        <br />
        <p>Feel free to check out my socials and get in touch! <br />I am currently looking for internship opportunities for Summer 2024!</p>
      </div>
    </div>
  );
};
